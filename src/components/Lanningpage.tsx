...
export default function Lanningpage() {
  return (
    <div>
                  ...
                  <div className="carousel-caption d-flex flex-column align-items-center justify-content-center">
                    <div className="p-3" style={{ maxWidth: 700 }}>
                      ...
                      <p className="mx-md-5 px-5 animate__animated animate__bounceIn">
                        ใส่แล้วเย็นสบายไม่แน่นอึดอัดตัวและมีความสวยงามในแบบของไทย
                      </p>
                      <a
                ...
                >
                  ...
                  <div className="carousel-caption d-flex flex-column align-items-center justify-content-center">
                    <div className="p-3" style={{ maxWidth: 700 }}>
                      ...
                      <p className="mx-md-5 px-5 animate__animated animate__bounceIn">
                        ใส่แล้วมีความเป็นเอกลักษณ์ในตัวใส่แล้วสวย
                      </p>
                      <a
                        className="btn btn-outline-light py-2 px-4 mt-3 animate__animated animate__fadeInUp"
                        href="#"
                ...
                >
                  ...
                  <div className="carousel-caption d-flex flex-column align-items-center justify-content-center">
                    <div className="p-3" style={{ maxWidth: 700 }}>
                      ...
                      <p className="mx-md-5 px-5 animate__animated animate__bounceIn">
                        เด็กคนไหนใส่แล้วก็มีความน่ารักในตัว
                      </p>
                      <a
                        className="btn btn-outline-light py-2 px-4 mt-3 animate__animated animate__fadeInUp"
                        href="#"
            ...
            <a className="text-decoration-none" href="">
              <div className="cat-item d-flex align-items-center mb-4">
                ...
                <div className="flex-fill pl-3">
                  <h6>เนื้อโคขุนโพยังคำ</h6>
                  <small className="text-body">ราคาเป็นกันเอง</small>
                </div>
              </div>
            </a>
          </div>
          <div className="col-lg-3 col-md-4 col-sm-6 pb-1">
            <a className="text-decoration-none" href="">
              <div className="cat-item img-zoom d-flex align-items-center mb-4">
                ...
                <div className="flex-fill pl-3">
                  <h6>นํ้าหมักเม้า</h6>
                  <small className="text-body">ทรัพคุณหลากหลาย</small>
                </div>
              </div>
            </a>
          </div>
            ...
            <a className="text-decoration-none" href="">
              <div className="cat-item img-zoom d-flex align-items-center mb-4">
                <div
                  ...
                  style={{ width: 100, height: 100 }}
                >
                  <img className="img-fluid" src="img/cloth12..webp" alt="" />
                </div>
                <div className="flex-fill pl-3">
                  <h6>นํ้าผึ้งป่า</h6>
                  <small className="text-body">
                    รสชาติหวานนำไปทำของหวานก็อร่อย
                  </small>
                </div>
              </div>
            </a>
          ...
          <div className="col-lg-3 col-md-4 col-sm-6 pb-1">
            <a className="text-decoration-none" href="">
              <div className="cat-item img-zoom d-flex align-items-center mb-4">
                ...
                <div className="flex-fill pl-3">
                  <h6>ทุเรียน</h6>
                  <small className="text-body">กลิ่นหอมรสชาติหวานมัน</small>
                </div>
              </div>
            </a>
          </div>
